...
func newMigrationSource(inst instance.Instance, stateful bool, instanceOnly bool, allowInconsistent bool, clusterMoveSourceName string, storagePool string, devices api.DevicesMap, dependentVolumesMove bool, pushTarget *api.InstancePostTarget) (*migrationSourceWs, error) {
	ret := migrationSourceWs{
		...
		devices:               devices,
		dependentVolumesMove:  dependentVolumesMove,
	}
...
func (s *migrationSourceWs) do(migrateOp *operations.Operation) error {
	...
	err = s.instance.MigrateSend(instance.MigrateSendArgs{
		...
		Devices:              s.devices,
		DependentVolumesMove: s.dependentVolumesMove,
	})
	if err != nil {
