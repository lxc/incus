...
type InstanceServer interface {
	...
	GetInstanceDirectBackupFile(instanceName string, backup api.InstanceBackupsPost, req *BackupFileRequest) (err error)
	...
	GetStoragePoolBucketDirectBackupFile(pool string, bucketName string, backup api.StorageBucketBackupsPost, req *BackupFileRequest) (err error)
	...
	GetStorageVolumeDirectBackupFile(pool string, volName string, backup api.StorageVolumeBackupsPost, req *BackupFileRequest) (err error)
