...
// GetStoragePoolBucketDirectBackupFile requests that Incus creates and returns new direct backup
// for the storage bucket.
func (r *ProtocolIncus) GetStoragePoolBucketDirectBackupFile(poolName string, bucketName string, backup api.StorageBucketBackupsPost, req *BackupFileRequest) error {
	// Build the URL
