...
// GetStorageVolumeDirectBackupFile requests that Incus creates and returns new direct backup for
// the storage volume.
func (r *ProtocolIncus) GetStorageVolumeDirectBackupFile(pool string, volName string, backup api.StorageVolumeBackupsPost, req *BackupFileRequest) error {
	// Build the URL
