...
- If the image was copied from a remote server using the [`lxc image copy`](incus_image_copy.md) command, it is automatically updated only if the `--auto-update` flag was specified.
