...
type Metrics struct {
	...
	NodeBootTimeSeconds uint64              `json:"node_boot_time_seconds" yaml:"node_boot_time_seconds"`
	NodeTimeSeconds     uint64              `json:"node_time_seconds" yaml:"node_time_seconds"`
}
